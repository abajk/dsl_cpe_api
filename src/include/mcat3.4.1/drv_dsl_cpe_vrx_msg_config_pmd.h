...
#define ALM_ModemFSM_FailReasonGet_S_MAXSOS 0x2C
#define ALM_ModemFSM_FailReasonGet_S_SOS_MINRATE 0x2D
#define ALM_ModemFSM_FailReasonGet_S_IMAP_DRIVER_REQ_ON 0x2E
#define ALM_ModemFSM_FailReasonGet_S_IMAP_DRIVER_REQ_OFF 0x2F
#define ALM_ModemFSM_FailReasonGet_S_PP_TC2LINE_RES 0x30
...
#define ACK_ModemFSM_FailReasonGet_S_MAXSOS 0x2C
#define ACK_ModemFSM_FailReasonGet_S_SOS_MINRATE 0x2D
...
#define CMD_OperatorSelect_TELCO_TTNET 20
...
#define ACK_OperatorSelectionGet_TELCO_TTNET 20
...
/**
   ...
   and annex support).(References: Section 7.3.1.1.1 of G.997.1 and G.994.1 [6]
   Tables "Standard information field - SPar(1) coding")
*/
...
/**
   ...
   G.997.1 [7]). Bearer channel configuration at the CPE is optional and just
...
/**
   ...
   [7]). Bearer channel configuration at the CPE is optional and just used to
...
struct CMD_BearerCh0_DS_Set
{
   ...
   /** Maximum Differential Delay BC0 ATM DS (IMA+ Bonding only) */
   DSL_uint8_t maxDiffDelay0_ATMds;
